...
export default function DashboardPage() {
  ...
  const categoriesWithDue = categories.map(cat => ({
    ...cat,
    ...
    <div style={{
      ...
      <nav style={{
        ...
        <button
          ...
          style={{ padding: '8px 18px', backgroundColor: '#6B4226',
      ...
      <div style={{ maxWidth: '560px', margin: '0 auto',
        padding: '28px 16px', position: 'relative', zIndex: 1 }}>
        ...
        <div style={{
          ...
          marginBottom: '20px', animation: 'fadeUp 0.4s ease 0.3s both'
        }}>
          <div style={{ display: 'flex', justifyContent: 'space-between',
            ...
            <span style={{ backgroundColor: "#6B4226", color: "white",
              ...
              {categoriesWithDue.length > 0 ? categoriesWithDue.length : categories.length} subjects
            </span>
          </div>
